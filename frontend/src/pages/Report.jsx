...
import { getManagerTasks, getProjects, getManagerProjects, getDirectorReport, BASE } from "../services/api.js";
    ...
    async function loadReportData() {
      try {
        ...
        if (user.role === "Staff") {
          ...
          const departmentId = freshUserData.department?._id ||
            freshUserData.department ||
            user.department?._id ||
            user.department;

          if (!departmentId) {
            throw new Error("Director must be assigned to a department");
          }
